...
<input type="hidden" name="base_url" id="base_url" value="<?php echo base_url();?>">
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><img src="<?php echo base_url().HOUSEY_LOGO; ?>logo.png" height ="60" ></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?php echo base_url().HOUSEY_LOGO;?>logo.png" height ="60" id=""></span>
    </a>
